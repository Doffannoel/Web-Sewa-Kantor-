...
export default async function OfficeSpaceDetailPage({ params }: Props) {
  ...
  const office = officeSpaces.find(
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="font-extrabold text-[32px] leading-[44px]">
                {/* You should use office.title instead of officeSpaces.title, since officeSpaces is an array and office is the selected item. */}
                {office.title}
              </h1>
